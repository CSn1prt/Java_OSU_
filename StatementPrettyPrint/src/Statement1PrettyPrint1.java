...
public final class Statement1PrettyPrint1 extends Statement1 {
    ...
    public void prettyPrint(SimpleWriter out, int offset) {
        ...
        final int indent = Program.INDENT_SIZE;

        switch (this.kind()) {
            case BLOCK: {

                // TODO - fill in case
                final int len = this.lengthOfBlock();
                Statement subtree = this.newInstance();

                for (int index1 = 0; index1 < len; index1++) {
                    subtree = this.removeFromBlock(index1);
                    subtree.prettyPrint(out, offset);
                    this.addToBlock(index1, subtree);
                }
            ...
            case IF: {
                ...
                // TODO - fill in case
                Statement subtree = this.newInstance();
                Condition condition = this.disassembleIf(subtree);
                ...
                out.println("END IF");
                this.assembleIf(condition, subtree);
            ...
            case IF_ELSE: {
                ...
                Condition condition = this.disassembleIfElse(subtreeIf,
                        subtreeElse);
                ...
                printSpaces(out, offset);
                out.println("END IF");
                this.assembleIfElse(condition, subtreeIf, subtreeElse);
            ...
            case WHILE: {
                ...
                Statement subtree = this.newInstance();
                Condition condition = this.disassembleWhile(subtree);
                printSpaces(out, offset);
                ...
                this.assembleWhile(condition, subtree);
            ...
            case CALL: {
                ...
                // TODO - fill in case
                String temp = this.disassembleCall();
                printSpaces(out, offset);
                out.println(temp);
                this.assembleCall(temp);
