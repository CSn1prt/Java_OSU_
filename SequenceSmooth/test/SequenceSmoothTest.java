...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <1234, 1234> and s2 = <1>.
     */
    @Test
    public void test3() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(1234, 1234);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(1234, 1234);
    ...
    /**
     * Test smooth with s1 = <16, 18, 35> and s2 = <-15, 22>.
     */
    @Test
    public void test4() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(16, 18, 35);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(16, 18, 35);
        Sequence<Integer> seq2 = this.createFromArgs(-15, 22);
        Sequence<Integer> expectedSeq2 = this.createFromArgs();
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
