...
public final class Tokenizer {
    ...
    private static String nextWordOrSeparator(String text, int position) {
        ...
        //this part (for loop) creates a set of separators.

        int index = position;
        boolean ifSeparator = strSet.contains(text.charAt(position));

        while (index < text.length()
                && strSet.contains(text.charAt(index)) == ifSeparator) {
    ...
    public static Queue<String> tokens(SimpleReader in) {
        ...
        //The part creating set of separators.
        ...
        while (!in.atEOS()) {
            ...
            while (position < temp.length()) {
                ...
                if (!strSet.contains(temp.charAt(position))) {
