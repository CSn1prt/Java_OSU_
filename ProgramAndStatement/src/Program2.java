...
public class Program2 extends ProgramSecondary {
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        // TODO - fill in body
        Map<String, Statement> tempMap = this.context.newInstance();

        tempMap.transferFrom(this.context);

        this.context.transferFrom(c);

        c.transferFrom(tempMap);
    ...
    public final Statement newBody() {
        ...
        Statement response = this.body.newInstance();
    ...
    public final void swapBody(Statement b) {
        ...
        // TODO - fill in body
        Statement stat = this.body.newInstance();

        stat.transferFrom(this.body);
